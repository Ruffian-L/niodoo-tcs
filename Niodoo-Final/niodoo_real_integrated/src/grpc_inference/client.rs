...
use crate::grpc_inference::server::proto::{
    onnx_inference_service_client::OnnxInferenceServiceClient, BatchInferenceRequest,
    BatchInferenceResponse, HealthCheckRequest, HealthCheckResponse, InferenceRequest,
    InferenceResponse, LoadModelRequest, LoadModelResponse,
};
