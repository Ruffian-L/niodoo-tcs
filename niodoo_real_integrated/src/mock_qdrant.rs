...
//! - Qdrant service is unavailable during testing
//! 
//! **DO NOT USE IN PRODUCTION** - Always use real Qdrant service (HTTP 6333, gRPC 6334)
//! 
//! Real implementation: Use `erag.rs::EragClient` with actual Qdrant endpoint
