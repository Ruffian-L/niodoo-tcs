...
impl GpuTensorFusion {
    ...
    pub fn fused_fitness_calculation(
        ...
        let stacked = Tensor::cat(&[temporal_2d, pad_2d, beta1_2d, retrieval_2d, consonance_2d], 1)?;
...
mod tests {
    ...
    fn test_fused_fitness() {
        ...
        let result = fusion.fused_fitness_calculation(
            &temporal, &pad_salience, &retrieval, &beta1, &consonance, &weights
        ).unwrap();
