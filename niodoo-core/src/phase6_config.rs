...
// ============================================================================
// PHASE 6 INTEGRATION TYPE DEFINITIONS
// ============================================================================
...
pub struct SystemMetrics {
    ...
    pub memory_metrics: Option<MemoryStats>,
...
/// Learning metrics for consciousness evolution tracking
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct LearningMetrics {
    /// Current learning rate
    pub learning_rate: f32,
    /// Retention score (0.0 to 1.0)
    pub retention_score: f32,
    /// Adaptation effectiveness score
    pub adaptation_effectiveness: f32,
    /// Consciousness plasticity score
    pub plasticity: f32,
...
/// Performance snapshot for point-in-time metrics
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PerformanceSnapshot {
    /// Timestamp of the snapshot
    pub timestamp: u64,
    /// System metrics at this point in time
    pub system_metrics: SystemMetrics,
    /// Learning metrics at this point in time
    pub learning_metrics: Option<LearningMetrics>,
}

/// Memory statistics for memory management tracking
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// GPU metrics for GPU acceleration tracking
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// I/O metrics for I/O performance tracking
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Performance metrics for consciousness logging
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// Learning analytics for consciousness logging
#[derive(Debug, Clone, Serialize, Deserialize)]
