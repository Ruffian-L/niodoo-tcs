...
// Re-export MultiLayerMemoryQuery and related types
pub use memory::multi_layer_query::{MemoryWithResonance, MultiLayerMemoryQuery};

// Re-export MemoryConsolidationEngine and related types
pub use memory::consolidation::{
    ConsolidatedMemory, ConsolidationStats, ConsolidationStrategy, MemoryConsolidationEngine,
};
